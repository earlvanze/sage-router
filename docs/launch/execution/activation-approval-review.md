...
- Approval packet freshness: `issuedAt=1782826775; expiresAt=1782827675; validSeconds=900; requiredForRealSend=true.`
...
- refresh_recent_approval_packet=ready: Packet issued at 1782826775; expires at 1782827675; re-run the approval packet after 900 seconds before any real send.
...
curl -fsS -X POST https://api.sagerouter.dev/admin/customers/send-activation-followups \
  ...
  -H "Origin: https://app.sagerouter.dev" \
  -H "Content-Type: application/json" \
  --data '{"status":"inactive","segment":"verified","limit":25,"dryRun":false,"sendConfirmation":"SEND_ACTIVATION_FOLLOWUPS","approvalPacketIssuedAt":1782826775}'
