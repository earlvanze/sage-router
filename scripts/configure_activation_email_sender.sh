...
Optional:
  ...
  SAGE_ROUTER_ACTIVATION_EMAIL_REDIRECT_TO="https://app.sagerouter.dev/account.html?activation=recovery"
...
REDIRECT_TO="${SAGE_ROUTER_ACTIVATION_EMAIL_REDIRECT_TO:-https://app.sagerouter.dev/account.html?activation=recovery}"
