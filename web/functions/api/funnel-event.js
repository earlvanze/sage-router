const ALLOWED_EVENTS = new Set([
  ...
  'shared_email_key_recovery_clicked',
  'fusion_viewed',
  ...
  'managed_access_contact_packet_copied',
  ...
  'gateway_compare_key_recovery_clicked',
  ...
  'login_key_recovery_magic_link_requested',
  'login_key_recovery_magic_link_sent',
  'login_key_recovery_magic_link_failed',
  'login_key_recovery_password_submitted',
  ...
  'status_activation_email_preflight_copied',
  'status_activation_approval_packet_copied',
  'status_managed_resale_dry_run_copied',
  'status_managed_terms_approval_copied',
