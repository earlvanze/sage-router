...
- Keep `/setup-key-recovery` aligned with public edge 401 `keyRecoveryUrl` payloads, same-email account recovery, generated-key-before-checkout setup, sitemap, LLM discovery, and readiness checks.
