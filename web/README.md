...
The account page uses the same endpoint for signed-in activation and checkout
intent: signup/login attempt, OAuth click, selected plan, API-key creation,
...
source/target URL, and allowlisted metadata; Supabase Auth, generated-key
records, billing webhooks, route usage, and Supabase customer records remain
authoritative for activation and paid conversion.
