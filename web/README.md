...
- Community launch kit at `/community-launch-kit` with copyable Show HN, Indie Hackers, and Dev.to launch copy, measured community campaign links, no-secret posting boundaries, sitemap, LLM discovery, and readiness checks.
