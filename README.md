...
Founder-sales kit copy actions roll into `/analytics/funnel.marketingIntent.founderSalesOutreachCopies` and `founderSalesOutreachCopiesBySnippet`, so Lite/Pro/Max and one-subscription direct outreach is visible as a first-class launch metric instead of only raw event rows.
