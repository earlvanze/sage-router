...
The Umbrel app pins `ghcr.io/earlvanze/sage-router-public:v3.28.9` and stores its config under the app data directory. The built-in config dashboard is accessible from the Umbrel app tile.
...
docker run -p 8790:8790 \
  ...
  ghcr.io/earlvanze/sage-router-public:v3.28.9
```
