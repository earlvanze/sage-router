...
class CloudflareWorkerEdgeTests(unittest.TestCase):
    ...
    def test_cloudflare_bic_skip_script_reports_ruleset_permission_failures(self):
        ...
        self.assertIn("Candidate statuses:", script)
        self.assertIn("rulesetReadable=", script)
        self.assertIn("rulesetStatus=", script)
        self.assertIn("Manual Cloudflare UI fallback:", script)
        self.assertIn("Cloudflare Dashboard > sagerouter.dev > Rules > Configuration Rules > Create rule", script)
        self.assertIn('Expression: http.host eq "api.sagerouter.dev"', script)
        self.assertIn("Browser Integrity Check to Off", script)
        self.assertIn("do not disable Browser Integrity Check for sagerouter.dev", script)
        ...
        self.assertIn("requiredPermissions", script)
        self.assertIn("canApplyExistingCandidate", script)
    ...
    def test_cloudflare_bic_runbook_is_discoverable(self):
        ...
        self.assertIn("operator packet print candidate numbers", doc)
        ...
        self.assertIn("manual Cloudflare UI fallback", doc)
        self.assertIn("Configuration Rules > Create rule", doc)
        self.assertIn('Expression: `http.host eq "api.sagerouter.dev"`', doc)
        self.assertIn("Scope warning", doc)
